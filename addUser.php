...
<main id="main" class="main">
    ...
    <form action='insUser.php' method='post' enctype="multipart/form-data">
        ...
        <div class="col-sm-10">
            <input type='text' name='telepon_user'> <br/>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-sm-10">
                <input type='text' name='peran_user'> <br/>
            </div>
        </div>
        <div class="col-sm-10">
            <input type='submit' value='Simpan' name="submit_user">
        </div>
    </form>
</main>
</body>
